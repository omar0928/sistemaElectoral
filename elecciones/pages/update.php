...
<body>
  ...
  ?>
  <div class="estilo">
    <form action="../Logic/updateRedirect.php?id =<?php echo isset($_POST['id']); ?>&&que=<?php echo $_GET['id']; ?>" method="post">
      <label for="">Que desea editar?</label>
      <?php $logic->listButtons(isset($_GET['id']), 'editar'); ?>
        ...
        <tbody>
          <?php foreach ($listPartidos as $value) : ?>
            <tr>
              ...
              <td><img src="<?php echo $value->logo;?>" alt="" width="200px" height="200px"></td>
        ...
        <tbody>
          <?php foreach ($listCandidato as $value) : ?>
            ...
            <tr>
              ...
              <td><img src="<?php echo  $value->foto; ?>" alt="" width="200px" height="200px"></td>
              <td><?php echo $value->estado; ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
