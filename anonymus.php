        ...
        <table class="table">
          ...
          <tbody>
            ...
            <?php foreach($listCandidato as $value) : ?>
                ...
                ?>
                <?php if(isset($_GET['id']) == 1 && $puesto == 'presidente'):?>
            <tr>
              ...
              <td><button type="submit" class="btn btn-primary" value="<?php echo $value->id;?>" name="voto">votar</button></td>
                ...
                <?php endif; ?>
                <!--  -->
                <?php if(isset($_GET['id']) == 2 && $puesto == 'regidor'):?>
            <tr>
              <td><?php echo  $value->id;?></td>
              <td><?php echo  $value->nombre;?></td>
              <td><?php echo  $value->apellido;?></td>
              ...
              <td><button type="submit" class="btn btn-primary" value="<?php echo $value->id;?>" name="voto">votar</button></td>
                ...
                <?php endif; ?>
                <!--  -->
                <?php if(isset($_GET['id']) == 3 && $puesto == 'diputado'):?>
            <tr>
              <td><?php echo  $value->id;?></td>
              <td><?php echo  $value->nombre;?></td>
              <td><?php echo  $value->apellido;?></td>
              ...
              <td><button type="submit" class="btn btn-primary" value="<?php echo $value->id;?>" name="voto">votar</button></td>
                ...
                <?php endif; ?>
                <!--  -->
                <?php if(isset($_GET['id']) == 4 && $puesto == 'senador'):?>
            <tr>
              <td><?php echo  $value->id;?></td>
              <td><?php echo  $value->nombre;?></td>
              <td><?php echo  $value->apellido;?></td>
              ...
              <td><button type="submit" class="btn btn-primary" value="<?php echo $value->id;?>" name="voto">votar</button></td>
                ...
                <?php endif; ?>
                <!--  -->
                <?php if(isset($_GET['id']) == 5 && $puesto == 'alcalde'):?>
            <tr>
              <td><?php echo  $value->id;?></td>
              <td><?php echo  $value->nombre;?></td>
              <td><?php echo  $value->apellido;?></td>
